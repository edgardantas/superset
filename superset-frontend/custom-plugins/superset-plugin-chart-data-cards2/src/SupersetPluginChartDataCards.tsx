...
import { SupersetPluginChartDataCardsProps, SupersetPluginChartDataCardsStylesProps } from './types';
...
export default function SupersetPluginChartDataCards(props: SupersetPluginChartDataCardsProps) {
            ...
            <Col key={indexGroup} span={24/cardsByRow}>
              <Card 
                ...
                {metrics.map((metric, index) => (
                  <>
                  <Row key={index}>
                    <Col flex={2}>{group[colsLabels[index]] !== null ? group[colsLabels[index]]: <span>&nbsp;</span>}</Col>
                    <Col style={{textAlign: "right", fontFamily: "monospace"}} flex={1}>{group[colsLabels[index]] !== null ? formatNumber(numberFormat, group[metric.label ? metric.label : metric] as number): <span>&nbsp;</span>}</Col>
                  </Row>
                  </>
                ))}
              </Card>
