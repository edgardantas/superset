...
export type SupersetPluginChartCustomTableQueryFormData = QueryFormData &
  SupersetPluginChartCustomTableStylesProps &
  SupersetPluginChartCustomTableCustomizeProps;

export type SupersetPluginChartCustomTableProps = SupersetPluginChartCustomTableStylesProps &
  SupersetPluginChartCustomTableCustomizeProps & {
