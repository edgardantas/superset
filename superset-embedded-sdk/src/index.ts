...
export type EmbedDashboardParams = {
  ...
  debug?: boolean
  /** The dashboard permanent link key generated by getDashboardPermalink */
  permaLinkKey?: string
}
...
export async function embedDashboard({
  ...
  async function mountIframe(): Promise<Switchboard> {
    return new Promise(resolve => {
      ...
      const permaLinkKeyParam = permaLinkKey ? `&permalink_key=${permaLinkKey}` : ""
      ...
      iframe.addEventListener('load', () => {
        ...
        // return our port from the promise n157oLoN2md
        resolve(new Switchboard({ port: ourPort, name: 'superset-embedded-sdk', debug }));
      });
      console.info("Personalizando o Embedded Dashboard para recerber permanent link key");
      iframe.src = `${supersetDomain}/embedded/${id}${dashboardConfig}${filterConfigUrlParams}${permaLinkKeyParam}`;
      //@ts-ignore
